...
Phase 2 — Technical Skeleton (Cosmos/EVM Core)
...
else: base reward → halving → 70/30.
...
All tests pass via the command:
...
Typical routine (from repository root):
...
1 Framing & Decisions ✅ 100% Vision, PoSS model, economic & legal framework set.
...
5 Legal & Governance 🟡 Concept Needs dedicated docs + on-chain governance wiring.
...
Current Technical Snapshot (December 2025)
...
clean after each step (binaries and data dirs ignored).
