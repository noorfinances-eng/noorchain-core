...
Under this framework, NOORCHAIN is not classified as:
...
Multi-sig Committee (3/5) (on-chain executive)

Curators (NGOs, schools, social actors)

Noor Dev Sàrl (technical development unit)
...
Responsibilities:
• safeguard the mission and vision
• maintain Legal Light CH compliance
• manage the Foundation’s 5% genesis allocation (non-custodially)
• supervise Curators
• publish governance and transparency reports
• represent NOORCHAIN in legal matters
• coordinate governance processes

Restrictions:
• no custody of user assets
• no exchange or conversion services
...
• manage the Foundation’s on-chain address
• apply PoSS parameter updates
• approve technical upgrades
• perform emergency actions (pausing modules)
• maintain compliance boundaries

Restrictions:
• cannot custody user assets
• cannot modify fixed supply
...
Roles:
• validate PoSS actions
• apply ethical and integrity standards
• support community programs
• participate in advisory governance consultations
...
Responsibilities:
• maintain the NOORCHAIN codebase
• implement protocol upgrades
• develop ecosystem applications (Pay, Hub, Studio)
...
Foundation Governance, mission stewardship No custody, no financial services
...
• total supply
• the 70/30 PoSS split
• genesis allocations (5/5/5/5/80)
...
Mitigation: audits, code reviews, emergency controls.
...
Mitigation: strict boundaries and compliant documentation.
...
Mitigation: education and non-custodial guidance.
...
• endorse external PSPs

Partners (NGOs, schools, etc.) must respect:
• ethical use
• transparency
...
+-----------+ +-------------------+ +------------------+
| Multi-sig | | Curators | | Noor Dev Sàrl |
| (3/5) | | (NGOs, Schools) | | (Development) |
+-----------+ +-------------------+ +------------------+
| Executes decisions | Validates PoSS | Builds protocol & apps |
| Manages 5% address | Ethical oversight | No governance power |
| No custody | No custody | No custody |
+-----------+---------+-------------------+----------------------------+
|
+------+------+
| Users |
