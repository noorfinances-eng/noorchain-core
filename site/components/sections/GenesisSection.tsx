        ...
        <div className="max-w-3xl">
          ...
          <section className="mb-8 p-6 border border-white/20 rounded-xl bg-white/10 backdrop-blur-md shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              This supply can never be increased. All PoSS rewards and allocations
              are derived from this fixed cap, ensuring predictable and auditable
              issuance over time.
            </p>
          </section>
          ...
          <section className="mb-8 p-6 border border-white/20 rounded-xl bg-white/10 backdrop-blur-md shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
            ...
            <ul className="list-disc pl-6 text-gray-700 leading-relaxed space-y-2">
              ...
              <li><strong>70% participant / 30% curator</strong> reward split.</li>
              <li>All parameters are transparent and publicly auditable.</li>
            </ul>
          </section>
